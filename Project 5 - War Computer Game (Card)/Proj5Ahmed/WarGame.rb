...
class WarGame
  ...
  def play
  	...
  	# if Player a wins add card to Player stack with cards in Limbo stack.
  	if card_a.rank > card_b.rank
  	  ...
  	  # if Player b wins add card to Player stack with cards in Limbo stack.
      ...
      # if there is a tie
  		...
  		#dealing additional three cards in limbo stack 
  		(1..3).each do 
